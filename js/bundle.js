...
function timer(id, deadLine) {
    ...
    function getTimeRemaining(endTime) {
        ...
        if (t <= 0) {
            ...
            days = Math.floor(t / (1000 * 60 * 60 * 24)), // получаем количество суток оставшихся
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    let modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)('.modal', modalTimerId), 300000);
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2023-09-21');
});
})();
